...
def main():
    ...
    # 手动通过卡方过滤挑选特征
    test_dataset.drop(['FileModifyTime', 'FileCreateTime', 'IsWrite', 'IsRead', 'IsExecute', 'ExceptionError',
        'ExportRVA', 'NumberOfExFunctions', 'NumberOfImFunctions', 'IATRVA', 'Signature', 'DebugRVA',
        'StackReserveSize', 'NumberOfSections'], axis=1, inplace=True)
