...
TRAIN_RAW_DATASET_PATH = RAW_DATASET_PATH+'fastflux_dataset/train/pdns.csv'         # 训练集原始数据集路径
...
TEST_RAW_DATASET_PATH  = RAW_DATASET_PATH+'fastflux_dataset/test/pdns.csv'          # 测试集原始数据集路径
...
MODEL_SCORE_PATH       = MODEL_PATH+'model.score'
