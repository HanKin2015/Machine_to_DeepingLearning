...
# 读取数据
trainSets = pd.read_csv('./data/train.csv',header=0)
testSets = pd.read_csv('./data/test.csv')
...
print(cross_val_score(classifier, trainSets_A_features, trainSets_A_target).mean())  
print(cross_val_score(classifierNA, trainSets_NA_features, trainSets_NA_target).mean()) 
